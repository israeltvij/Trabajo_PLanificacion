# -*- coding: utf-8 -*-
"""
Created on Sat Mar 22 00:00:06 2025
...
# Agregar restricción para asegurar que cada punto tenga al menos una batería tipo 1
...
for p in range(P):
    model += xb[p][0] >= 1  # Asegura que haya al menos una batería tipo 1 en cada punto
